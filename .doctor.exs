%Doctor.Config{
  # Generated by `NimbleCSV.define/2` in lib/nonprofiteer/ingest/bmf.ex — a parser module we
  # don't author the body of, so it carries no moduledoc. Narrow, name-pinned exemption.
  ignore_modules: [Nonprofiteer.Ingest.Bmf.Csv, Nonprofiteer.Ingest.Efile.Index.Csv],
